...
shows Codex and Claude pool allowances, and never mutates account state.
...
so this is a conservative match using the available metadata. Missing match
fields leave `main` visible.
